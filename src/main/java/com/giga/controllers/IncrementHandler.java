...
/**
 * @since 1.2
 * Increment handler for JavaFX Spinner to speed up spinner behavior
 * From: https://stackoverflow.com/questions/41050085/javafx-spinner-change-is-slow-with-click-and-hold-of-mouse-button/43393337
 */
...
class IncrementHandler implements EventHandler<MouseEvent> {
    ...
    private static final long DELAY = 1000l * 1000L * 100L;
    private Node button;
